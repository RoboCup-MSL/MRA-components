...
#define MRA_LOG_TICK() MRA::Logging::LogTick scoped(MRA_COMPONENT_NAME, MRA_COMPONENT_FOLDER, __FILE__, __LINE__, timestamp, input, params, &state, &output, &local, &error_value)
