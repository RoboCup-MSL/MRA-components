...
typedef MRA::FalconsVelocityControl::Diagnostics DiagnosticsType;


class FalconsVelocityControl: public MRAInterface<InputType, ParamsType, StateType, OutputType, DiagnosticsType>
{
public:
