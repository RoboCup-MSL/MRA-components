...
#ifndef _MRA_ROBOTSPORTS_LOCAL_BALL_TRACKING_DATATYPES_HPP
#define _MRA_ROBOTSPORTS_LOCAL_BALL_TRACKING_DATATYPES_HPP

#include "components/robotsports/local_ball_tracking/interface/Input.pb.h"
