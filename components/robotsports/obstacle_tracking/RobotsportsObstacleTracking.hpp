...
typedef MRA::RobotsportsObstacleTracking::Diagnostics DiagnosticsType;


class RobotsportsObstacleTracking: public MRAInterface<InputType, ParamsType, StateType, OutputType, DiagnosticsType>
{
public:
