...
#define MRA_COMPONENT_NAME "FalconsTrajectoryGeneration"
#endif
#ifndef MRA_COMPONENT_FOLDER
#define MRA_COMPONENT_FOLDER "falcons/trajectory_generation"
#endif
...
#include "FalconsTrajectoryGeneration_datatypes.hpp"
...
class FalconsTrajectoryGeneration: public MRAInterface<InputType, ParamsType, StateType, OutputType, DiagnosticsType>
{
public:
    ...
    {
        return MRA::LoadDefaultParams<ParamsType>("components/falcons/trajectory_generation/interface/DefaultParams.json");
    };
