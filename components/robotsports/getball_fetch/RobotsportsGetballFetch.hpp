...
#define MRA_COMPONENT_FOLDER "robotsports/getball_fetch"
#endif
...
class RobotsportsGetballFetch: public MRAInterface<InputType, ParamsType, StateType, OutputType, DiagnosticsType>
{
public:
    ...
    {
        return MRA::LoadDefaultParams<ParamsType>("components/robotsports/getball_fetch/interface/DefaultParams.json");
    };
