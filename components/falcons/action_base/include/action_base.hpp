...
#include <type_traits>
#include <cstdint>
#include "mra_msgs/msg/action_type.hpp"
#include "mra_msgs/msg/action_result.hpp"
...
public:
    ...
    ActionBase(const std::string& name, mra_msgs::msg::ActionType type)
    : name_(name), type_(type), actionresult_(mra_msgs::msg::ActionResult::ACTIONRESULT_INVALID)
    {}
    ...
    virtual void tick(const input_type& input) = 0;
