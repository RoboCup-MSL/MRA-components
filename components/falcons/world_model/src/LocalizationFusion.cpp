...
void LocalizationFusion::updatePoseFromOdometry(const Twist& velocity, const Time& timestamp)
{
...
void LocalizationFusion::correctPoseFromVision(const std::vector<VisionObject>& vision_objects)
{
...
double LocalizationFusion::timeToSeconds(const Time& time)
{
    return time.sec + time.nanosec * 1e-9;
}

double LocalizationFusion::quaternionToYaw(const geometry_msgs::msg::Quaternion& q)
{
...
geometry_msgs::msg::Quaternion LocalizationFusion::yawToQuaternion(double yaw)
{
