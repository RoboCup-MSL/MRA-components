...
public:
    Environment() {};
    Environment(double field_length, double field_width, double field_margin, double goal_width, double goal_length,
...
private:
    ...
    Environment FillDefaultFieldConfig(); // only for off-line tests (automatic tests)
