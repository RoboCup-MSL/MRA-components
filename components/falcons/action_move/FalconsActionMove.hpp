...
typedef MRA::FalconsActionMove::Diagnostics DiagnosticsType;


class FalconsActionMove: public MRAInterface<InputType, ParamsType, StateType, OutputType, DiagnosticsType>
{
public:
    FalconsActionMove() {};
    ~FalconsActionMove() {};
