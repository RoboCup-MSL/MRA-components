...
#define MRA_COMPONENT_NAME "RobotsportsVelocityControl"
#endif
#ifndef MRA_COMPONENT_FOLDER
#define MRA_COMPONENT_FOLDER "robotsports/velocity_control"
#endif
...
#include "RobotsportsVelocityControl_datatypes.hpp"
...
typedef MRA::RobotsportsVelocityControl::Diagnostics DiagnosticsType;


class RobotsportsVelocityControl: public MRAInterface<InputType, ParamsType, StateType, OutputType, DiagnosticsType>
{
public:
    ...
    {
        return MRA::LoadDefaultParams<ParamsType>("components/robotsports/velocity_control/interface/DefaultParams.json");
    };
