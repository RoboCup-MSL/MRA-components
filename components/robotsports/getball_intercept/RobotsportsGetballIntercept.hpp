...
class RobotsportsGetballIntercept: public MRAInterface<InputType, ParamsType, StateType, OutputType, DiagnosticsType>
{
public:
    ...
    {
        return MRA::LoadDefaultParams<ParamsType>("components/robotsports/getball_intercept/interface/DefaultParams.json");
    };
