#include "action_get_ball.hpp"
#include <cmath>

ActionGetBall::ActionGetBall()
: ActionBase("getball", mra_common_msgs::msg::ActionType::ACTION_GETBALL)
{
}

void ActionGetBall::tick(const mra_common_msgs::msg::WorldState& world_state, const input_type& input)
{
    // Reset verdict and result
    verdict_.clear();
    actionresult_ = mra_common_msgs::msg::ActionResult::ACTIONRESULT_INVALID;
    ...
    if (world_state.robot.hasball) {
        actionresult_ = mra_common_msgs::msg::ActionResult::ACTIONRESULT_PASSED;
    ...
    if (!world_state.robot.active) {
        actionresult_ = mra_common_msgs::msg::ActionResult::ACTIONRESULT_FAILED;
    ...
    double action_radius = config_.radius;
    if (input.radius > 0.0) {
    ...
    actionresult_ = mra_common_msgs::msg::ActionResult::ACTIONRESULT_RUNNING;
