...
#ifndef _MRA_ROBOTSPORTS_PATH_PLANNING_HPP
#define _MRA_ROBOTSPORTS_PATH_PLANNING_HPP
...
#define MRA_COMPONENT_NAME "RobotsportsPathPlanning"
#endif
#ifndef MRA_COMPONENT_FOLDER
#define MRA_COMPONENT_FOLDER "robotsports/path_planning"
#endif
...
namespace MRA::RobotsportsPathPlanning
{

typedef MRA::RobotsportsPathPlanning::Input InputType;
typedef google::protobuf::Empty ParamsType; // no .proto -> unused
typedef google::protobuf::Empty StateType; // no .proto -> unused
typedef MRA::RobotsportsPathPlanning::Output OutputType;
typedef google::protobuf::Empty DiagnosticsType; // no .proto -> unused


class RobotsportsPathPlanning: public MRAInterface<InputType, ParamsType, StateType, OutputType, DiagnosticsType>
{
public:
    RobotsportsPathPlanning() {};
    ~RobotsportsPathPlanning() {};
    ...
    {
        return MRA::LoadDefaultParams<ParamsType>("components/robotsports/path_planning/interface/DefaultParams.json");
    };
...
}; // class RobotsportsPathPlanning


// configuration handling
inline ParamsType defaultParams()
{
    return RobotsportsPathPlanning().defaultParams();
}
