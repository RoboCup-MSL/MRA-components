...
#ifndef _MRA_ROBOTSPORTS_LOCAL_BALL_PREPROCESSOR_HPP
#define _MRA_ROBOTSPORTS_LOCAL_BALL_PREPROCESSOR_HPP
...
#define MRA_COMPONENT_NAME "RobotsportsLocalBallPreprocessor"
#endif
#ifndef MRA_COMPONENT_FOLDER
#define MRA_COMPONENT_FOLDER "robotsports/local_ball_preprocessor"
#endif
...
#include "RobotsportsLocalBallPreprocessor_datatypes.hpp"




namespace MRA::RobotsportsLocalBallPreprocessor
{

typedef MRA::RobotsportsLocalBallPreprocessor::Input InputType;
typedef MRA::RobotsportsLocalBallPreprocessor::Params ParamsType;
typedef google::protobuf::Empty StateType; // no .proto -> unused
typedef MRA::RobotsportsLocalBallPreprocessor::Output OutputType;
typedef google::protobuf::Empty DiagnosticsType; // no .proto -> unused


class RobotsportsLocalBallPreprocessor: public MRAInterface<InputType, ParamsType, StateType, OutputType, DiagnosticsType>
{
public:
    RobotsportsLocalBallPreprocessor() {};
    ~RobotsportsLocalBallPreprocessor() {};
    ...
    {
        return MRA::LoadDefaultParams<ParamsType>("components/robotsports/local_ball_preprocessor/interface/DefaultParams.json");
    };
...
}; // class RobotsportsLocalBallPreprocessor


// configuration handling
inline ParamsType defaultParams()
{
    return RobotsportsLocalBallPreprocessor().defaultParams();
}
