...
#ifndef _MRA_ROBOTSPORTS_LOCAL_OBSTACLE_TRACKING_DATATYPES_HPP
#define _MRA_ROBOTSPORTS_LOCAL_OBSTACLE_TRACKING_DATATYPES_HPP

#include "components/robotsports/local_obstacle_tracking/interface/Input.pb.h"
