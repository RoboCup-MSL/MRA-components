...
#ifndef _MRA_FALCONS_LOCALIZATION_VISION_DATATYPES_HPP
#define _MRA_FALCONS_LOCALIZATION_VISION_DATATYPES_HPP

#include "components/falcons/localization_vision/interface/Input.pb.h"
