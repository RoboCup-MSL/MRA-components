...
=== proof_is_alive [[proof_is_alive]]
The robot will proof it is alive, by executing the behavior as specified in the MSL rules. This action  can be requested by the referee to proof that a robot is still functioning.

link:../../../../.././components/robotsports/proof_is_alive/README.adoc[Read-me: Proof-Is-Alive]
