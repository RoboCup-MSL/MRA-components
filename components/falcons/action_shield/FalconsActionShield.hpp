...
#ifndef _MRA_FALCONS_ACTION_SHIELD_HPP
#define _MRA_FALCONS_ACTION_SHIELD_HPP
...
#define MRA_COMPONENT_NAME "FalconsActionShield"
#endif
#ifndef MRA_COMPONENT_FOLDER
#define MRA_COMPONENT_FOLDER "falcons/action_shield"
#endif
...
#include "FalconsActionShield_datatypes.hpp"




namespace MRA::FalconsActionShield
{

typedef MRA::FalconsActionShield::Input InputType;
typedef MRA::FalconsActionShield::Params ParamsType;
typedef MRA::FalconsActionShield::State StateType;
typedef MRA::FalconsActionShield::Output OutputType;
typedef MRA::FalconsActionShield::Diagnostics DiagnosticsType;


class FalconsActionShield: public MRAInterface<InputType, ParamsType, StateType, OutputType, DiagnosticsType>
{
public:
    FalconsActionShield() {};
    ~FalconsActionShield() {};
    ...
    {
        return MRA::LoadDefaultParams<ParamsType>("components/falcons/action_shield/interface/DefaultParams.json");
    };
...
}; // class FalconsActionShield


// configuration handling
inline ParamsType defaultParams()
{
    return FalconsActionShield().defaultParams();
}
