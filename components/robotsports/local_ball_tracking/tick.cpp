...
static void copy_to_ball_feature_struct(ball_feature_t& r_bf, const ::MRA::RobotsportsLocalBallTracking::BallFeature observed_ball_feature, long sensor_label) {
...
int calculate_velocity(xy_t *velocity, xy_t *data, long order, double sample)
{
	...
	case 4:
		...
		break;
	case 5:
		velocity->x = (16*data[0].x + data[1].x - 10*data[2].x - 10*data[3].x - 6*data[4].x + 9*data[5].x) / (28*sample);
		velocity->y = (16*data[0].y + data[1].y - 10*data[2].y - 10*data[3].y - 6*data[4].y + 9*data[5].y) / (28*sample);
		break;
	case 6:
		velocity->x = (12*data[0].x + 5*data[1].x - 8*data[2].x - 6*data[3].x - 10*data[4].x + data[5].x + 6*data[6].x) / (28*sample);
		velocity->y = (12*data[0].y + 5*data[1].y - 8*data[2].y - 6*data[3].y - 10*data[4].y + data[5].y + 6*data[6].y) / (28*sample);
		break;
	case 7:
		velocity->x = (22*data[0].x + 7*data[1].x - 6*data[2].x - 11*data[3].x - 14*data[4].x - 9*data[5].x - 2*data[6].x + 13*data[7].x) / (60*sample);
		velocity->y = (22*data[0].y + 7*data[1].y - 6*data[2].y - 11*data[3].y - 14*data[4].y - 9*data[5].y - 2*data[6].y + 13*data[7].y) / (60*sample);
		break;
	default:
		velocity->x = 0.0;
		velocity->y = 0.0;
...
int RobotsportsLocalBallTracking::RobotsportsLocalBallTracking::tick
(
