...
#ifndef _MRA_ROBOTSPORTS_PROVE_IS_ALIVE_DATATYPES_HPP
#define _MRA_ROBOTSPORTS_PROVE_IS_ALIVE_DATATYPES_HPP

#include "components/robotsports/Prove_is_alive/interface/Input.pb.h"
